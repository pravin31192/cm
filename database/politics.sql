...
CREATE TABLE `constituencies` (
  ...
  `current_member_name` varchar(128) DEFAULT NULL,
...
('m000000_000000_base', 1521539552),
('m130524_201442_init', 1521539561);
...
--
-- Table structure for table `party_postings`
--

CREATE TABLE `party_postings` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `politicians` (
  ...
  `previous_party` int(11) DEFAULT NULL,
  `previous_party_name` varchar(512) DEFAULT NULL,
  `active_from` int(11) DEFAULT NULL,
  `mobile_no` varchar(128) DEFAULT NULL,
  `personal_email_id` varchar(256) DEFAULT NULL,
  `official_email_id` varchar(256) DEFAULT NULL,
  `fb_profile` text,
...
--
-- Table structure for table `politician_review`
--

CREATE TABLE `politician_review` (
  `id` int(11) NOT NULL,
